...
module.exports = {
    ...
    SESSION: process.env.CHINTU_CODE === undefined ? '' : process.env.CHINTU_CODE,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'CHINTU BOT' : process.env.BOT_NAME,
    ...
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://wa.me/94740979220' : process.env.SOCIAL_MEDIA,
    ...
    SUDO: process.env.SUDO === undefined ? '94740979220,0' : process.env.SUDO,
    DEBUG: DEBUG,
